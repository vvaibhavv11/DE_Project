...
async function imageToArray() {
    ...
    const imagData = Array.from(imageData)
    return imagData
}
...
uploadForm.onsubmit = async (e) => {
    ...
    const response = await invoke('text_from_image', { image: await imageToArray() });
...
contactForm.onsubmit = async (e) => {
    ...
    const response = await invoke('semail', { sender_email: email.value, mess: message.value })
